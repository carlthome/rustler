...
use crate::{BEAT_WINDOW, CRAB_SIZE, PLAYER_SIZE};

/// Rival King Crab train AI (wander/pursuit, chain-splice steal, player steal-back, free-crab
/// pickup, player/NPC collisions) and its conga-train draw pass. Split out of main.rs to keep
/// that file navigable.
impl MainState {
