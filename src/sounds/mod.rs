...
// Musical structure.
pub use music::{
    ACTION_KEY_ROOT_MIDI, GROOVE_SWING, detect_bpm_from_ogg, synth_biome_action_groove,
    synth_intro_menu, synth_theme_deus_ambient, synth_theme_deus_tense, synth_theme_duck_bounce,
    synth_theme_duck_funky, synth_theme_duck_golden,
};
