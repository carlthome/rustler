...
pub use audio::{
    ...
    synth_rival_steal, synth_startup_pling, synth_steal_gain, synth_steal_loss, synth_stomp,
    synth_whistle, BeatSynth, PadPreset, Waveform,
};
// Musical structure.
pub use music::{
    detect_bpm_from_ogg, synth_action_groove, synth_theme_deus_ambient, synth_theme_deus_tense,
    synth_theme_duck_bounce, synth_theme_duck_funky, synth_theme_duck_golden, ACTION_KEY_ROOT_MIDI,
    GROOVE_SWING,
};
