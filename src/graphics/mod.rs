...
// Beat-feedback ring / pulse / shockwave / trail effects (chain rings, catch shockwaves & trails,
// fear & tide pulses, and the on-beat ability rings). Re-exported so every `graphics::draw_*`
// call-site path is unchanged.
mod rings;
pub use rings::*;
