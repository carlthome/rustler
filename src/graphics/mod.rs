...
// Per-crab/per-rival "aura" and status overlays (Armored shell arc, Hermit coil, magnet
// glow, magnet/thief/splitter auras, golden sparkle, cleave stakes/slash, tail-run badge)
// live in their own file. Re-exported so every `graphics::draw_*` call-site path is unchanged.
mod auras;
pub use auras::*;
