//! Conga-chain risk mechanics: kelp snags, panic snaps, King Crab splicing, the Thief
//! parasite's tail-peel raid, and the train body physically deflecting fleeing crabs.
//! Split out of main.rs — same MainState, same behaviour, just grouped by subsystem.
...
impl MainState {
    ...
    pub(crate) fn ricochet_deflected_crabs(&mut self) {
