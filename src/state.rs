...
pub struct MainState {
    ...
    // Per-magnet nearby-free-crab tallies, reused each frame so the cluster detection walks
    // self.crabs once (inner loop over the tiny magnet list) instead of once per magnet.
