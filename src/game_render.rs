...
impl MainState {
    ...
    fn draw_game(
        ...
        // The world-space scene is done; hand off to the screen-space HUD pass, which re-pins the
        // canvas to a fixed viewport rect and draws everything screen-anchored (weather overlay,
        // minimap, tool roster, meters, banners, flashlight). See `game_render_hud.rs`.
